...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=0.002,
                        help='learning rate')
    parser.add_argument('--GA_dropout', type=float, default=0.0,
                        help='GlobalAttention dropout rate')
    parser.add_argument('--GT_dropout', type=float, default=0.0,
    ...
    for l in range(1):
        ...
        if adaptive_lr == 'False':
            ...
            optimizer = torch.optim.Adam([{'params': model.linear1.parameters()},
                                          ...
                                          {'params': model.GlobalAttention.parameters(), "lr": 0.0005,
                                           "weight_decay": 0.0},
                                          {'params': model.GraphTrans.parameters(), "lr": 0.002, "weight_decay": 0.0},
